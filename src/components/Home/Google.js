...
{/* CABOOZE MARKER/INFO */}   
    ...
    >
      <InfoWindow title= "CABOOZE" onCloseClick={props.onToggleOpen}>
        <div style={{ backgroundColor: `white`, opacity: 0.75, padding: `12px`, width: `100px`, height: `100px` }}>
          <div style={{ fontSize: `16px`, fontColor: `#08233B` }}>
            <img src="https://cdn.ticketfly.com/wp-content/themes/cabooze/images/bg-header.jpg" alt="Cabooze Music Club Logo" width="75" height="50"></img>
...
{/* HONEY MARKER/INFO */}  
    ...
    >
      <InfoWindow title= "HONEY" onCloseClick={props.onToggleOpen}>
        <div style={{ backgroundColor: `white`, opacity: 0.75, padding: `12px`, width: `100px`, height: `100px` }}>
          <div style={{ fontSize: `16px`, fontColor: `#08233B` }}>
            <img src="http://honeympls.com/wp-content/uploads/2016/10/logo.png" alt="Honey MPLS Logo" width="75" height="75"></img>
...
{/* DAKOTA MARKER/INFO */}   
    ...
    >
      <InfoWindow title= "DAKOTA" onCloseClick={props.onToggleOpen}>
        <div style={{ backgroundColor: `white`, opacity: 0.75, padding: `12px`, width: `100px`, height: `100px` }}>
          <div style={{ fontSize: `16px`, fontColor: `#08233B` }}>
          <img src="https://www.dakotacooks.com/wp-content/uploads/2018/07/logo_blue.png" alt="Dakota Logo" width="75" height="50"></img>
...
{/* ICEHOUSE MARKER/INFO */}
    ...
    >
      <InfoWindow title= "ICEHOUSE" onCloseClick={props.onToggleOpen}>
        <div style={{ backgroundColor: `white`, opacity: 0.75, padding: `12px`, width: `100px`, height: `100px` }}>
          <div style={{ fontSize: `16px`, fontColor: `#08233B` }}>
            <img src="https://static1.squarespace.com/static/550dddbbe4b0ffd939b69799/t/5a2fcc71f9619a81671580aa/1543548017919/Cards.jpg?format=500w" alt="Icehouse Card" width="75" height="50"></img>
...
{/* KITTY CAT CLUB MARKER/INFO */}  
    ...
    >
      <InfoWindow title= "KITTYCAT" onCloseClick={props.onToggleOpen}>
        <div style={{ backgroundColor: `white`, opacity: 0.75, padding: `12px`, width: `100px`, height: `100px` }}>
          <div style={{ fontSize: `16px`, fontColor: `#08233B` }}>
            <img src="https://static1.squarespace.com/static/58e669f615d5db0a8449fbd8/t/5955139d29687fe976c38899/1544537438250/?format=1500w" alt="Kitty Cat Club Logo" width="75" height="50"></img>
...
{/* NOMAD MARKER/INFO */}  
    ...
    >
      <InfoWindow title= "NOMAD" onCloseClick={props.onToggleOpen}>
        <div style={{ backgroundColor: `white`, opacity: 0.75, padding: `12px`, width: `100px`, height: `100px` }}>
        <div style={{ fontSize: `16px`, fontColor: `#08233B` }}>
          <img src="http://www.nomadpub.com/wp-content/themes/nomad/images/nomad-logo.png" alt="Nomad Pub Logo" width="75" height="75"></img>
...
{/* PALMERS MARKER/INFO */}  
    ...
    >
      <InfoWindow title= "PALMERS" onCloseClick={props.onToggleOpen}>
        <div style={{ backgroundColor: `white`, opacity: 0.75, padding: `12px`, width: `100px`, height: `100px` }}>
          <div style={{ fontSize: `16px`, fontColor: `#08233B` }}>
            <img src="http://palmersbar.net/wp-content/themes/palmers/img/sm-brand-transp.gif" alt="Palmers Guy" width="50" height="75"></img>
...
{/* HEXAGON MARKER/INFO */}  
    ...
    >
      <InfoWindow title= "HONEY" onCloseClick={props.onToggleOpen}>
        <div style={{ backgroundColor: `white`, opacity: 0.75, padding: `12px`, width: `100px`, height: `100px` }}>
          <div style={{ fontSize: `16px`, fontColor: `#08233B`, width: `50px`, height: `75px` }}>
